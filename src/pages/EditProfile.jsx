...
const EditProfile = () => {
      ...
      const fetchUserProfile = async () => {
        try {
          const response = await axios.get(
            "https://job-portal-server-theta-olive.vercel.app/api/user-profile",
      ...
      try {
        ...
        if (user?.role === 3) {
          response = await axios.get(
            "https://job-portal-server-theta-olive.vercel.app/api/user-profile/skills",
            { withCredentials: true }
          );
          setSkills(response.data.skills || []);
        } else if (user?.role === 2) {
          response = await axios.get(
            "https://job-portal-server-theta-olive.vercel.app/api/recruiter-profile/skills",
            { withCredentials: true }
          );
          setSkills(response.data.skills || []);
        }
  ...
  const fetchWorkExperiences = async () => {
    try {
      const response = await axios.get(
        "https://job-portal-server-theta-olive.vercel.app/api/work-experience",
        { withCredentials: true }
      );
  ...
  const handleUpdateResume = async () => {
    ...
    try {
      await axios.patch(
        "https://job-portal-server-theta-olive.vercel.app/api/users/update-resume",
        { resume: resumeLink },
        { 
          withCredentials: true,
          headers: {
  ...
  useEffect(() => {
    if (user?.role === 2) {
      const fetchRecruiterProfile = async () => {
        try {
          const response = await axios.get(
            "https://job-portal-server-theta-olive.vercel.app/api/recruiter-profile",
            { withCredentials: true }
          );
  ...
  useEffect(() => {
    ...
    if (currentMobile && currentMobile !== user?.mobile_no) {
      const resetVerification = async () => {
        try {
          await axios.patch(
            "https://job-portal-server-theta-olive.vercel.app/api/users/update-mobile-edit",
            {},
            { withCredentials: true }
          );
  ...
  const handleSaveSocialLinks = async () => {
    ...
    try {
      await axios.patch(
        "https://job-portal-server-theta-olive.vercel.app/api/user-profile/social-links",
        { social_links: socialLinks },
        { withCredentials: true }
      );
  ...
  const fetchProjects = async () => {
    try {
      const response = await axios.get(
        "https://job-portal-server-theta-olive.vercel.app/api/projects",
        { withCredentials: true }
      );
  ...
  const handleSaveAbout = async () => {
    ...
    try {
      await axios.patch(
        "https://job-portal-server-theta-olive.vercel.app/api/user-profile/about",
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      ...
      if (credential) {
        ...
        await axios.patch(
          "https://job-portal-server-theta-olive.vercel.app/api/users/update-mobile-verification",
          { 
