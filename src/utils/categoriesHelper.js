...
export const fetchCategoriesByName = async (searchTerm) => {
  try {
    const response = await fetch(`https://job-portal-server-six-eosin.vercel.app/api/categories/search?q=${encodeURIComponent(searchTerm)}`, {
      credentials: 'include',
    });
...
export const fetchCategoriesByIds = async (ids) => {
  try {
    ...
    const response = await fetch('https://job-portal-server-six-eosin.vercel.app/api/categories/by-ids', {
      method: 'POST',
      headers: {
...
export const fetchSuggestedCategories = async (searchTerm) => {
  try {
    const response = await fetch(`https://job-portal-server-six-eosin.vercel.app/api/categories/suggested`, {
      credentials: 'include'
    });
